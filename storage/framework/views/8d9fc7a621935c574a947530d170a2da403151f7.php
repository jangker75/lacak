        ...
        <div class="col-sm-12">
            ...
            <div id='panel-form-<?php echo e($name); ?>' class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class='row'>
                        <div class='col-sm-10'>
                            <div class="panel panel-default">
                                <div class="panel-heading"><i class="fa fa-pencil-square-o"></i> <?php echo e(trans("crudbooster.text_form")); ?></div>
                                <div class="panel-body child-form-area">
                                    <?php $__currentLoopData = $form['columns']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $name_column = $name.$col['name'];?>
                                        <div class='form-group'>
                                            <?php if($col['type']!='hidden'): ?>
                                                <label class="control-label col-sm-2"><?php echo e($col['label']); ?>

                                                    <?php if(!empty($col['required'])): ?> <span class="text-danger"
                                                                                        title="<?php echo e(trans('crudbooster.this_field_is_required')); ?>">*</span> <?php endif; ?>
                                                </label>
                                            <?php endif; ?>
                                            <div class="col-sm-10">
                                                <?php if($col['type']=='text'): ?>
                                                    <input id='<?php echo e($name_column); ?>' type='text'
                                                           <?php echo e(($col['max'])?"maxlength='".$col['max']."'":""); ?> name='child-<?php echo e($col["name"]); ?>'
                                                           class='form-control <?php echo e($col['required']?"required":""); ?>'
                                                ...
                                                <?php elseif($col['type']=='radio'): ?>
                                                    ...
                                                    <label class="radio-inline">
                                                        <input type="radio" name="child-<?php echo e($col['name']); ?>"
                                                               class='<?php echo e(($e==0 && $col['required'])?"required":""); ?> <?php echo e($name_column); ?>'
                                                               value="<?php echo e($radio_value); ?>"<?php echo e(($e==0 && $col['required'])?" checked":""); ?>> <?php echo e($radio_label); ?>
								        ...
								        <button class="btn btn-primary" onclick="showModal<?php echo e($name_column); ?>()" type="button"><i
                                                    class='fa fa-search'></i> <?php echo e(trans('crudbooster.datamodal_browse_data')); ?></button>
								      </span>
                                                    </div><!-- /input-group -->

                                                    <?php $__env->startPush('bottom'); ?>
                                                        <script type="text/javascript">
                                                            var url_<?php echo e($name_column); ?> = "<?php echo e(CRUDBooster::mainpath('modal-data')); ?>?table=<?php echo e($col['datamodal_table']); ?>&columns=id,<?php echo e($col['datamodal_columns']); ?>&name_column=<?php echo e($name_column); ?>&where=<?php echo e(urlencode($col['datamodal_where'])); ?>&select_to=<?php echo e(urlencode($col['datamodal_select_to'])); ?>&columns_name_alias=<?php echo e(urlencode($col['datamodal_columns_alias'])); ?>";
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <h4 class="modal-title"><i
                                                                                class='fa fa-search'></i> <?php echo e(trans('crudbooster.datamodal_browse_data')); ?> <?php echo e($col['label']); ?>

                                                                    </h4>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <iframe id='iframe-modal-<?php echo e($name_column); ?>' style="border:0;height: 430px;width: 100%"
                                                                            src=""></iframe>
                                                                </div>
                                                ...
                                                <?php elseif($col['type']=='number'): ?>
                                                    <input id='<?php echo e($name_column); ?>' type='number'
                                                           <?php echo e(($col['min'])?"min='".$col['min']."'":""); ?> <?php echo e(($col['max'])?"max='$col[max]'":""); ?> name='child-<?php echo e($col["name"]); ?>'
                                                           class='form-control <?php echo e($col['required']?"required":""); ?>'
                                                            <?php echo e(($col['readonly']===true)?"readonly":""); ?>

                                                    />
                                                <?php elseif($col['type']=='textarea'): ?>
                                                    <textarea id='<?php echo e($name_column); ?>' name='child-<?php echo e($col["name"]); ?>'
                                                              class='form-control <?php echo e($col['required']?"required":""); ?>' <?php echo e(($col['readonly']===true)?"readonly":""); ?> ></textarea>
                                                <?php elseif($col['type']=='upload'): ?>
                                                    <div id='<?php echo e($name_column); ?>' class="input-group">
                                                        <input type="hidden" class="input-id">
                                                        <input type="text" class="form-control input-label <?php echo e($col['required']?"required":""); ?>" readonly>
                                                        <span class="input-group-btn">
								        <button class="btn btn-primary" id="btn-upload-<?php echo e($name_column); ?>" onclick="showFakeUpload<?php echo e($name_column); ?>()"
                                                type="button"><i class='fa fa-search'></i> <?php echo e(trans('crudbooster.datamodal_browse_file')); ?></button>
								      </span>
                                                    </div><!-- /input-group -->
                                                        ...
                                                        <script type="text/javascript">
                                                            ...
                                                            function prepareUpload<?php echo e($name_column); ?>(event) {
                                                                ...
                                                                if (filesize > max_size) {
                                                                    sweetAlert('<?php echo e(trans("crudbooster.alert_warning")); ?>', '<?php echo e(trans("crudbooster.your_file_size_is_too_big")); ?>', 'warning');
                                                                    return false;
                                                                }
                                                                ...
                                                                if (is_image_only) {
                                                                    if ($.inArray(extension, img_extension) == -1) {
                                                                        sweetAlert('<?php echo e(trans("crudbooster.alert_warning")); ?>', '<?php echo e(trans("crudbooster.your_file_extension_is_not_allowed")); ?>', 'warning');
                                                                        return false;
                                                                    }
                                                                } else {
                                                ...
                                                <?php elseif($col['type']=='select'): ?>
                                                    ...
                                                    <?php if($col['parent_select']): ?>
                                                        <?php $__env->startPush('bottom'); ?>
                                                            <script type="text/javascript">
                                                                $(function () {
                                                                    $("#<?php echo e($name.$col['parent_select']); ?> , #<?php echo e($name.$col['name']); ?>").select2("destroy");

                                                                    $('#<?php echo e($name.$col['parent_select']); ?>, input:radio[name=<?php echo e($name.$col['parent_select']); ?>]').change(function () {
                                                                        var $current = $("#<?php echo e($name.$col['name']); ?>");
                                                                        var parent_id = $(this).val();
                                                                        var fk_name = "<?php echo e($col['parent_select']); ?>";
                                                                        var fk_value = $('#<?php echo e($name.$col['parent_select']); ?>').val();
                                                                        var datatable = "<?php echo e($col['datatable']); ?>".split(',');
                                                                        var datatableWhere = "<?php echo e($col['datatable_where']); ?>";
                                                                        var table = datatable[0].trim('');
                                                                        var label = datatable[1].trim('');
                                                                        var value = "<?php echo e($value); ?>";

                                                                        if (fk_value != '') {
                                                                            $current.html("<option value=''><?php echo e(trans('crudbooster.text_loading')); ?> <?php echo e($col['label']); ?>");
                                                                            $.get("<?php echo e(CRUDBooster::mainpath('data-table')); ?>?table=" + table + "&label=" + label + "&fk_name=" + fk_name + "&fk_value=" + fk_value + "&datatable_where=" + encodeURI(datatableWhere), function (response) {
                                                                                if (response) {
                                                                                    ...
                                                                                    $.each(response, function (i, obj) {
                                                                                        ...
                                                                                        $("<option " + selected + " value='" + obj.select_value + "'>" + obj.select_label + "</option>").appendTo("#<?php echo e($name.$col['name']); ?>");
                                                                                    });
                                                                    ...
                                                                    $('#<?php echo e($name.$col['parent_select']); ?>').trigger('change');
                                                                    $("#<?php echo e($name.$col['name']); ?>").trigger('change');

                                                                    $("#<?php echo e($name.$col['parent_select']); ?> , #<?php echo e($name.$col['name']); ?>").select2();
                                                    ...
                                                    <select id='<?php echo e($name_column); ?>' name='child-<?php echo e($col["name"]); ?>'
                                                            class='form-control select2 <?php echo e($col['required']?"required":""); ?>'
                                                            <?php echo e(($col['readonly']===true)?"readonly":""); ?>
                                                ...
                                                <?php elseif($col['type']=='hidden'): ?>
                                                    <input type="<?php echo e($col['type']); ?>" id="<?php echo e($name.$col["name"]); ?>" name="child-<?php echo e($name.$col["name"]); ?>"
                                                           value="<?php echo e($col["value"]); ?>">
                                                <?php endif; ?>
                                    ...
                                    <?php $__env->startPush('bottom'); ?>
                                        <script type="text/javascript">
                                            ...
                                            function resetForm<?php echo e($name); ?>() {
                                                ...
                                                $('#panel-form-<?php echo e($name); ?>').find(".select2").val('').trigger('change');
                                            }
                                            ...
                                            function editRow<?php echo e($name); ?>(t) {
                                                ...
                                                currentRow = p;
                                                p.addClass('warning');
                                                $('#btn-add-table-<?php echo e($name); ?>').val('<?php echo e(trans("crudbooster.save_changes")); ?>');
                                                <?php $__currentLoopData = $form['columns']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            function validateForm<?php echo e($name); ?>() {
                                                ...
                                                $('#panel-form-<?php echo e($name); ?> .required').each(function () {
                                                    var v = $(this).val();
                                                    if (v == '') {
                                                        sweetAlert("<?php echo e(trans('crudbooster.alert_warning')); ?>", "<?php echo e(trans('crudbooster.please_complete_the_form')); ?>", "warning");
                                                        is_false += 1;
                                                    }
                                                })
                                            ...
                                            function addToTable<?php echo e($name); ?>() {
                                                ...
                                                $('#btn-add-table-<?php echo e($name); ?>').val('<?php echo e(trans("crudbooster.button_add_to_table")); ?>');
                                ...
                                <div class="panel-footer" align="right">
                                    <input type='button' class='btn btn-default' id="btn-reset-form-<?php echo e($name); ?>" onclick="resetForm<?php echo e($name); ?>()"
                                           value='<?php echo e(trans("crudbooster.button_reset")); ?>'/>
                                    <input type='button' id='btn-add-table-<?php echo e($name); ?>' class='btn btn-primary' onclick="addToTable<?php echo e($name); ?>()"
                                           value='<?php echo e(trans("crudbooster.button_add_to_table")); ?>'/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class='fa fa-table'></i> <?php echo e(trans('crudbooster.table_detail')); ?>
                        ...
                        <div class="panel-body no-padding table-responsive" style="max-height: 400px;overflow: auto;">
                            <table id='table-<?php echo e($name); ?>' class='table table-striped table-bordered'>
                                ...
                                <tr>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <td>
                                        <a href='#panel-form-<?php echo e($name); ?>' onclick='editRow<?php echo e($name); ?>(this)' class='btn btn-warning btn-xs'><i
                                                    class='fa fa-pencil'></i></a>
                                        <a href='javascript:void(0)' onclick='deleteRow<?php echo e($name); ?>(this)' class='btn btn-danger btn-xs'><i
