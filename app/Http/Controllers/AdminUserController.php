<?php namespace App\Http\Controllers;
	...
	class AdminUserController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Last Checkin Date","name"=>"last_checkin_date"];
			$this->col[] = ["label"=>"Last Checkin Location","name"=>"last_checkin_tenant","join"=>"tenant,nama"];
			$this->col[] = ["label"=>"Last Checkout Date","name"=>"last_checkout_date"];
			$this->col[] = ["label"=>"Last Checkout Location","name"=>"last_checkout_tenant","join"=>"tenant,nama"];
			$this->col[] = ["label"=>"Status Now","name"=>"status_check"];
