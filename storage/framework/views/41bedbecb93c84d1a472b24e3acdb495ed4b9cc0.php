...
$total = $result->total();
?>
<div class="col-md-4" style="margin:30px 0;"><span class="pull-right"><?php echo e(trans("crudbooster.filter_rows_total")); ?>

        : <?php echo e($from); ?> <?php echo e(trans("crudbooster.filter_rows_to")); ?> <?php echo e($to); ?> <?php echo e(trans("crudbooster.filter_rows_of")); ?> <?php echo e($total); ?></span></div>
                    ...
                    <form method='get' action=''>
                                    ...
                                    <div class='col-sm-3'>
                                        <select name='filter_column[<?php echo e($col["field_with"]); ?>][type]' data-type='<?php echo e($col["type_data"]); ?>'
                                            ...
                                            <?php if(in_array($col['type_data'],['string','varchar','text','char'])): ?>
                                                <option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'like')?"selected":""); ?> value='like'><?php echo e(trans("crudbooster.filter_like")); ?></option> <?php endif; ?>
                                            <?php if(in_array($col['type_data'],['string','varchar','text','char'])): ?>
                                                <option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'not like')?"selected":""); ?> value='not like'><?php echo e(trans("crudbooster.filter_not_like")); ?></option><?php endif; ?>

                                            <option typeallow='all'
                                                    <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '=')?"selected":""); ?> value='='><?php echo e(trans("crudbooster.filter_equal_to")); ?></option>
                                            <?php if(in_array($col['type_data'],['int','integer','double','float','decimal','time'])): ?>
                                                <option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '>=')?"selected":""); ?> value='>='><?php echo e(trans("crudbooster.filter_greater_than_or_equal")); ?></option><?php endif; ?>
                                            <?php if(in_array($col['type_data'],['int','integer','double','float','decimal','time'])): ?>
                                                <option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '<=')?"selected":""); ?> value='<='><?php echo e(trans("crudbooster.filter_less_than_or_equal")); ?></option><?php endif; ?>
                                            <?php if(in_array($col['type_data'],['int','integer','double','float','decimal','time'])): ?>
                                                <option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '<')?"selected":""); ?> value='<'><?php echo e(trans("crudbooster.filter_less_than")); ?></option><?php endif; ?>
                                            <?php if(in_array($col['type_data'],['int','integer','double','float','decimal','time'])): ?>
                                                <option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '>')?"selected":""); ?> value='>'><?php echo e(trans("crudbooster.filter_greater_than")); ?></option><?php endif; ?>
                                            <option typeallow='all'
                                                    <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '!=')?"selected":""); ?> value='!='><?php echo e(trans("crudbooster.filter_not_equal_to")); ?></option>
                                            <option typeallow='all'
                                                    <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'in')?"selected":""); ?> value='in'><?php echo e(trans("crudbooster.filter_in")); ?></option>
                                            <option typeallow='all'
                                                    <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'not in')?"selected":""); ?> value='not in'><?php echo e(trans("crudbooster.filter_not_in")); ?></option>
                                            <?php if(in_array($col['type_data'],['date','time','datetime','int','integer','double','float','decimal','timestamp'])): ?>
                                                <option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'between')?"selected":""); ?> value='between'><?php echo e(trans("crudbooster.filter_between")); ?></option><?php endif; ?>
                                            <option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'empty')?"selected":""); ?> value='empty'>Empty ( or
                                                Null)
                                            </option>
                                        </select>
                                    </div><!--END COL_SM_4-->
                                            ...
                                            <div class='col-sm-6'>
                                                <div class='input-group <?php echo e(($col["type_data"] == "time")?"bootstrap-timepicker":""); ?>'>
                                                    ...
                                                    <input
                                                            ...
                                                            type='text'
                                                            class='filter-value-between form-control <?php echo e((in_array($col["type_data"],["date","datetime","timestamp"]))?"datepicker":"timepicker"); ?>'
                                                             placeholder='<?php echo e($col["label"]); ?> <?php echo e(trans("crudbooster.filter_from")); ?>'
                                                            name='filter_column[<?php echo e($col["field_with"]); ?>][value][]' value='<?php
                                            ...
                                            <div class='col-sm-6'>
                                                <div class='input-group <?php echo e(($col["type_data"] == "time")?"bootstrap-timepicker":""); ?>'>
                                                    ...
                                                    <input
                                                            ...
                                                            type='text'
                                                            class='filter-value-between form-control <?php echo e((in_array($col["type_data"],["date","datetime","timestamp"]))?"datepicker":"timepicker"); ?>'
                                                            readonly placeholder='<?php echo e($col["label"]); ?> <?php echo e(trans("crudbooster.filter_to")); ?>'
                                                            name='filter_column[<?php echo e($col["field_with"]); ?>][value][]' value='<?php
                                                    $value = CRUDBooster::getValueFilter($col["field_with"]);
                        ...
                        <div class="modal-footer" align="right">
                            ...
                            <button class="btn btn-default btn-reset" type="reset"
                                    onclick='location.href="<?php echo e(Request::get("lasturl")); ?>"'><?php echo e(trans("crudbooster.button_reset")); ?></button>
                    ...
                    <form method='post' target="_blank" action='<?php echo e(CRUDBooster::mainpath("export-data?t=".time())); ?>'>
                        ...
                        <div class="modal-body">
                            ...
                            <p><a href='javascript:void(0)' class='toggle_advanced_report'><i
                                            class='fa fa-plus-square-o'></i> <?php echo e(trans("crudbooster.export_dialog_show_advanced")); ?></a></p>
                            ...
                            <div id='advanced_export' style='display: none'>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class='help-block'><input type='checkbox' name='default_paper_size'
                                                                   value='1'/> <?php echo e(trans("crudbooster.export_dialog_set_default")); ?></div>
                                </div>
