        ...
        <div class='box-body'>
            ...
            <div class='form-group'>
                ...
                <input type='text' readonly class='form-control' title='Hanya klik dan otomatis copy to clipboard (kecuali Safari)'
                       onClick="this.setSelectionRange(0, this.value.length); document.execCommand('copy');" value='<?php echo e(url('api')); ?>'/>
            </div>
            <div class='form-group'>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <sup>
                                ...
                                &nbsp; <a title='Edit This API' href="<?php echo e(url(config('crudbooster.ADMIN_PATH').'/api_generator/edit-api').'/'.$api->id); ?>"><i
                                ...
                                <table class='table table-bordered'>
                                    <tr>
                                        ...
                                        <td><input title='Click and copied !' type='text' class='form-control' readonly
                                                   ...
                                                   value="/<?php echo e($api->permalink); ?>"/></td>
                                    </tr>
                                    <tr>
                                        <td><strong>METHOD</strong></td>
                                        <td><?php echo e(strtoupper($api->method_type)); ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><em><?php echo $api->keterangan; ?></em></td>
                                    </tr>
                                </table>
                            </div>
                        </td>
