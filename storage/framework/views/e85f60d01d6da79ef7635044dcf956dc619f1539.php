<div class='form-group form-datepicker <?php echo e($header_group_class); ?> <?php echo e(($errors->first($name))?"has-error":""); ?>' id='form-group-<?php echo e($name); ?>'
    ...
    <div class="<?php echo e($col_width?:'col-sm-10'); ?>">
        <div class="input-group">
            ...
            <span class="input-group-addon"><a href='javascript:void(0)' onclick='$("#<?php echo e($name); ?>").data("daterangepicker").toggle();'><i
                            class='fa fa-calendar'></i></a></span>

            <input type='text' title="<?php echo e($form['label']); ?>" readonly
                   <?php echo e($required); ?> <?php echo e($readonly); ?> <?php echo $placeholder; ?> <?php echo e($disabled); ?> class='form-control notfocus input_datetime' name="<?php echo e($name); ?>" id="<?php echo e($name); ?>"
