<?php namespace App\Http\Controllers;
	...
	class AdminUserNikController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Tanggal Akses","name"=>"created_at"];
			...
			$this->form[] = ['label'=>'Kecamatan','name'=>'kecamatan_id','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'kecamatan,nama','parent_select'=>'kota_id'];
